...
CREATE table dim_PenalLaws (
	PenalLawSK int NOT NULL IDENTITY(1,1),
	pd_cd int NULL,
...
CREATE table dim_OffenseDescription (
	OffenseDescriptionSK int NOT NULL IDENTITY(1,1),
	ky_cd int NULL,
...
CREATE table dim_PDDetails (
	PDDetailsSK int NOT NULL IDENTITY(1,1),
...
CREATE table dim_AgeGroup (
	AgeGroupSK int NOT NULL IDENTITY(1,1),
...
CREATE table dim_Sex (
	SexSK int NOT NULL IDENTITY(1,1),
...
CREATE table dim_Race (
	RaceSK int NOT NULL IDENTITY(1,1),
...
CREATE TABLE stg_nypd_arrests (
	...
	perp_sex varchar(30) not null,
	perp_race varchar(30) not null,
	x_coord_cd numeric(20,2) not null,
	y_coord_cd numeric(20,2) not null,
	latitude numeric(20,18) not null,
	longitude numeric(20,18) not null,
